...
SRCS += $(addprefix $(d), \
	client.cc benchmark.cc replica.cc loop_client.cc)
...
$(d)loop_client: $(o)loop_client.o $(OBJS-spec-client) $(OBJS-vr-client) $(OBJS-fastpaxos-client) $(OBJS-unreplicated-client) $(OBJS-benchmark) $(LIB-udptransport)
...
BINS += $(d)client $(d)replica $(d)loop_client
